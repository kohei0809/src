...
public class TargetPathAgent_Return implements IAgent{
    ...
    boolean isChargeRequired = false, homingFlag = false;
    GridGraph graph;
    Random rand;
    ...
    private int robotID, counter, chargeCounter, checkInterval = 100, chargeTime = 2700;
    ...
    public TargetPathAgent_Return(int id, LitterSpawnPattern pattern, GridGraph graph, int seed) {
		setRobotID(id);
    ...
    public void update(ObservedData data){
            ...
            if(robotData.getBatteryLevel() == robotData.getRobotSpec().getCapacity()){
                ...
                if(homingFlag){
                    ...
                    if(chargeCounter == chargeTime){
                        ...
                        isChargeRequired = false;
                        chargeLogger.writeLine(data.getTime() + ",wait," + homingFlag + "," + robotData.getBatteryLevel());
                    }
                }
                else{
                    action = AgentActions.move;
        ...
        /*if(homingFlag && action == AgentActions.move){
    		...
    		actionLogger.writeLine(data.getTime() + "," + action + "," + isChargeRequired + "," + c.x + "," + c.y + "," + tc.x + "," + tc.y + "," + pc.x + "," + pc.y + "," + data.getRobotDataCollection().getRobotData(robotID).getBatteryLevel() + "," + pather.getCanArrive());
        }*/
