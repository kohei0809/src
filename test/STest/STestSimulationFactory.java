...
public class STestSimulationFactory extends SimulationFactory{
    //計画停止なし
    ...
    STestAgentManager agentManager;
    Evaluator evaluator;
    GridGraph graph;
    ...
    public void make(){
        ...
        agentManager = new STestAgentManager(environment, beType, seeds[environmentSeed + 3], graph);
