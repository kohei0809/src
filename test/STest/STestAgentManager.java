...
public class STestAgentManager implements IAgentManager{
    ...
    //planedStop
    int stop_number = 1;
    int max_stop_number = 2;
    int stop_robots_number = 10;
    int stop_interval = 1000000;
    ...
    public STestAgentManager(IEnvironment environment, BehaviorType behavior, int seed, GridGraph graph){
    ...
    public void normal(){
      ...
      //PlanedStop
        if(stop_number > max_stop_number) {
        	stop_number = max_stop_number;
        }
        int reservation_time = 500000 + stop_interval * (stop_number - 1);
        
        //
        int stop_time = reservation_time + 500000;
        int restart_time = stop_time + 500000;
        int stop_robots_number = 10;
