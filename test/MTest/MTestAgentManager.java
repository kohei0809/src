...
public class MTestAgentManager implements IAgentManager{
    ...
    public MTestAgentManager(IEnvironment environment, BehaviorType behavior, int seed, GridGraph graph){
        ...
        agentSuccessLogger = LogManagerContext.getLogManager().createWriter2("agentSuccessLogger");
        stopNumberLogger = LogManagerContext.getLogManager().createWriter2("stopNumberLogger");
    }
    ...
    public void multipleStoppable(){
        ...
        if(isStop){
            if(time == (stop_time + scount*stop_interval)){         
                ...
                //double prob = (double)sSum / pausingCount;
                onebyoneLogger.writeLine(time + "," + sSum + "," + fSum);
