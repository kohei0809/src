...
public class MTestSimulationFactory extends SimulationFactory{
    ...
    MTestAgentManager agentManager;
    Evaluator evaluator;
    GridGraph graph;
    ...
    public void make(){
        ...
        agentManager = new MTestAgentManager(environment, beType, seeds[environmentSeed + 3], graph);
