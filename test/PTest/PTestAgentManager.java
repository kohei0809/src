...
public class PTestAgentManager implements IAgentManager{
    ...
    public PTestAgentManager(IEnvironment environment, BehaviorType behavior, int seed, GridGraph graph){
