...
public class PTestSimulationFactory extends SimulationFactory{
    //計画停止なし
    ...
    PTestAgentManager agentManager;
    Evaluator evaluator;
    GridGraph graph;
    ...
    public void make(){
        ...
        agentManager = new PTestAgentManager(environment, beType, seeds[environmentSeed + 3], graph);
