...
public class CTestSimulationFactory extends SimulationFactory{
    //計画停止なし
    ...
    CTestAgentManager agentManager;
    Evaluator evaluator;
    GridGraph graph;
    ...
    public void make(){
        ...
        agentManager = new CTestAgentManager(environment, beType, seeds[environmentSeed + 3], graph);
