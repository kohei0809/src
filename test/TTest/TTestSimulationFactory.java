...
public class TTestSimulationFactory extends SimulationFactory{
    //計画停止なし
    ...
    TTestAgentManager agentManager;
    Evaluator evaluator;
    GridGraph graph;
    ...
    public void make(){
        ...
        agentManager = new TTestAgentManager(environment, beType, seeds[environmentSeed + 3], graph);
