...
public class NTestSimulationFactory extends SimulationFactory{
    ...
    NTestAgentManager agentManager;
    Evaluator evaluator;
    GridGraph graph;
    ...
    public void make(){
        ...
        agentManager = new NTestAgentManager(environment, beType, seeds[environmentSeed + 3], graph);
