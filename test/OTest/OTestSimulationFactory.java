...
public class OTestSimulationFactory extends SimulationFactory{
    static int[] seeds = new int[] { 31, 53, 79, 337, 449, 557, 601, 751, 809, 907, 977, 701, 1087, 1129, 1259, 1381, 
        1453, 1549, 1663, 1721, 1823, 2069, 2939, 3463, 4271, 5059, 5779, 6569, 7499, 8287, 8999, 9337, 9901, 10007, 
        10459, 10949, 11443, 11933, 12829, 13309, 13781, 14029, 15013,15451, 15913, 16433, 17431, 17923, 18371, 18947, 
        19949, 20399, 20939, 21419, 22381, 22877, 23369, 23873, 24923, 25447, 25943, 26437, 27509, 27997, 28547, 29017, 
        30103, 30643, 31151, 31657, 32653, 33179, 33637, 34213, 35251, 35809, 36319, 36821, 37871, 38449, 38971, 39499, 
        40591, 41143, 41627, 42139, 43117, 43721, 44257, 44789, 45341, 45943, 46489, 47057, 47581, 48661, 49177, 49711, 
        50221, 51361, 51853, 52391, 52967, 53527, 54049, 54581, 55163, 55717, 56239, 57241, 57791, 58321, 59399, 59971, 
        59998 };

    VirtualEnvironment environment;
    OTestAgentManager agentManager;
    Evaluator evaluator;
    GridGraph graph;
	...
	int environmentSeed = 0, agentSeed = 0;
    ...
    public void setLocalNumbers(int eseed, int aseed, int pseed, int pnumber, int tseed, int tnumber, int robotC, int s, 
            boolean isA, String pattern, BehaviorType bType, AgentType aType, double req, double cor){
        environmentSeed = eseed;
        agentSeed = aseed;
        patherSeed = pseed;
    ...
    public void make(){
        ...
        agentManager = new OTestAgentManager(environment, beType, seeds[environmentSeed + 3], graph);
