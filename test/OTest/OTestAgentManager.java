...
public class OTestAgentManager implements IAgentManager{
    ...
    public OTestAgentManager(IEnvironment environment, BehaviorType behavior, int seed, GridGraph graph){
