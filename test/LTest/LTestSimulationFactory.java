...
public class LTestSimulationFactory extends SimulationFactory{
    //計画停止なし
    ...
    LTestAgentManager agentManager;
    Evaluator evaluator;
    GridGraph graph;
    ...
    public void setLocalNumbers(int eseed, int aseed, int pseed, int pnumber, int tseed, int tnumber, int robotC, int s, 
            boolean isA, String pattern, BehaviorType bType, AgentType aType, double req){
        environmentSeed = eseed;
        agentSeed = aseed;
        patherSeed = pseed;
    ...
    public void make(){
        ...
        agentManager = new LTestAgentManager(environment, beType, seeds[environmentSeed + 3], graph);
    ...
    protected void createAgent(){
        ...
        for(int robot : robots.keySet()){
            ...
            RequirementEstimator estimator = new RequirementEstimator(graph, basePosition, 1.0);
